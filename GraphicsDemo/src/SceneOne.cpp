...
void SceneOne::DrawHellknight()
{
	glEnable(GL_DEPTH_TEST);
	glEnable(GL_CULL_FACE);

	renderer->SetCurrentShader(hellShader);
	...
	renderer->projMatrix = Matrix4::Perspective(1.0f, 10000.0f, (float)renderer->width / (float)renderer->height, 45.0f);
